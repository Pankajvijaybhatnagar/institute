        ...
        <div className="row mb-30">
          <div className="col-xl-12">
            <div className="team__area-title">
              <span className="subtitle__one">Student Corner</span>
              <h2>Facilities @ CBS</h2>
            </div>
          </div>
        </div>
            ...
            <div className="col-xl-3 col-lg-4 col-md-6 mt-30" key={id}>
              <div className="team__area-item">
                <div className="team__area-item-image">
                  <Image  style={{aspectRatio:8/9,objectFit:'cover'}} className="border border-black rounded" alt="" src={data.img} />
                  <div className="team__area-item-image-overlay">
                    <div className="team__area-item-image-overlay-social">
                      <Social />
                    </div>
                    <div className="team__area-item-image-overlay-content blur-lg border border-white">
